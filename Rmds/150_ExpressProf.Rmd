...
`r NOTE_bx` 
Errors bars (interval of the mean at 95% confidence) are expected to be small, indicating that the mean is reliable. However, you can see the profile of each gene in the cluster in [section ***Gene profiles***](#gene-profiles) below.
</div>
