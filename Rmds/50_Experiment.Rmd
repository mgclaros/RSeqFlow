...
2. The contrasts are automatically obtained from the `CONTRAST` list defined in `configure_wf.R` file. **Pay attention** since this es very tricky. Combined with the experimental `design`, it enables all comparisons.
    ```{r contrasts}
