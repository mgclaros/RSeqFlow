...
```{r decidetest-vs-topTreat, fig.width=5, fig.height=5, out.width='55%', fig.align='center'}
...
#                     show.plot = TRUE,
#                     intersections = TRUE)
# title("Total treat() DEGs from decideTests and from topTreat")

# venn.plot <- venn.diagram(venn.list, NULL,
#                           category.names = names(venn.list),
#                           cat.cex = 1.5, cat.fontface = "italic", cat.fontfamily = "sans", # Names
#                           cat.default.pos = "outer",
#                           lwd = 2, lty = 1,                                                # Circles
#                           cex = 2, fontface = "bold", fontfamily = "sans",                 # Numbers
#                           main = "Total treat() DEGs from decideTests and from topTreat")
# grid.draw(venn.plot)
