...
subtitle: "Using `r SOFT_NAME`; last code update on 29-VII-2022"
...
| Run **date & time**           | `r HOY` |
| **`r COMPUTER`**              | `r VERSION_R$platform` |
| **R** version                 | `r VERSION_R$version.string` |
...
The following steps are to reduce data dispersion, homogenise them around the mean, and adjust a linear model to obtain the most reliable [DEG]s.
